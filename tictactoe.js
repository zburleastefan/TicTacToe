    ...
    for(let i = 1; i < 10; ++i) {
        ...
        // add eventListener
        document.getElementById("parentGrid").appendChild(clickArea);
        ...
        clickArea.addEventListener("click", function ticTacToe() {
            ...
            // add the text node to the newly created area
            ...
            if (textId == ("text" + i)) {
                ...
                for (let line = 0; line < 8; ++line) {
                    ...
                    for (let column = 0; column < 3; ++column) {
                        ...
                        if (xWins == 3 || oWins == 3) {       // check if one of the players win
                            let player;
                            if (xWins == 3) {
                                player = "X";
                            } else {
                            ...
                            endGame();
                        } else if (clickNr == 9 && gameOver == 0) {     // check if it is a draw
